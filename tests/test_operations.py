...
from toloka_prefect.operations import (
    create_exam_pool,
    create_pool,
    create_project,
    create_tasks,
...
from toloka_prefect.utils import DEFAULT_TOLOKA_SECRET_NAME, structure_from_conf
...
def toloka_client_mock(
    ...
    with patch('toloka_prefect.utils.TolokaClient', Mock(return_value=client)):
        yield client
